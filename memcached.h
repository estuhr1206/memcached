...
} __attribute__((aligned(CACHE_LINE_SIZE))) PHYS_THREAD;
...
extern int memcached_perthread_init(void);

inline PHYS_THREAD *mythr(void)
{
    return mythr_ptr;
}
